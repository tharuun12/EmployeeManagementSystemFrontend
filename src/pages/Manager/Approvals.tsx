...
const ManagerApprovals = () => {
  ...
  const handleAction = async (status: "Approved" | "Rejected") => {
    ...
    setError("");
    try {
      await api.post(`manager/approvals`, {
        leaveRequestId: leave.leaveRequestId,
        status,
      });
      navigate("/manager/approvelist");
    } catch {
    ...
    <div className="create-form">
      ...
      <div className="review-details">
        <div className="form-group">
          ...
          <div className="form-value">{leave?.employee?.fullName || ""}</div>
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          <div className="form-value">{leave?.reason}</div>
        </div>
      </div>
      <form
        onSubmit={(e) => {
